...
import { Botonguardar, ColumnCreativeForm, ColumnInformative, CreativeFormContainer, 
    ImgToDoCreationPage, InfoContainer, InfoInsulines, InfoTag, Leash, ParrafoInformativo, 
    Separacion, Separaciondos, TitleInformation, TituloCreation, Triangle } from '../../atom/stylesCreationOrdersPage/stylesCreationOrders';
...
const FormNewOrder: FC<FormNewOrderData> = (props) => {
    ...
    const orderCreatedChangeValue = (event: any) => setOrderCreated({...orderCreated, [event.target.name]:event.target.value});
        ...
        <BoxPermissions className='InfoNewOrder'>
          ...
          <ColumnInformative>
            ...
            <ColumnCreativeForm>
                ...
                <Triangle/>
                <Leash><InfoTag>Ref 3345</InfoTag></Leash>
                    ...
                    <InputForm
                    type='number' value={props.newOrder.cellphone} onChange={event => props.setNewOrder({...props.newOrder, cellphone:event.target.value})} placeholder='Celular'
                    name="cellphone"
                    width='268px'
                    height='50px'
                    className='creationform'/>
                    ...
                    <InputForm
                    type='text' value={props.newOrder.place} onChange={event => props.setNewOrder({...props.newOrder, place:event.target.value})} placeholder='Direccion'
                    name="place"
                    width='700px'
                    height='50px'
                    className='creationform'/>
