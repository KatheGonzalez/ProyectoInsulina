...
const FormUpdateOrders: FC<FormUpdateOrder> = (props) => {
    return (
        <div>
            ...
            <InputForm type='number' value={props.orderUpdated.count}
            ...
            <InputForm type="text" value={props.orderUpdated.state}
            ...
            <InputForm type="text" value={props.orderUpdated.brand}
            ...
            <InputForm type="date" value={props.orderUpdated.date_collected} onChange={event => props.setOrderUpdated({
                ...props.orderUpdated,
